...
func main() {
	...
	// if we want to add new configuration variables, modify types Read API.
	...
	//metricsOptions builds metrics for tracking functions in the API gateway
	...
	//tracking functions metrics and report to Prometheus
	...
	fmt.Printf("functionURLResolver: %s\n", functionURLResolver)
	fmt.Printf("functionURLTransformer: %s\n", functionURLTransformer)
	//log.Fatalln(functionURLResolver)
	// log.Fatalln(functionURLTransformer)
