...
predictor = Predictor.deserialize(Path("/home/rongch05/openfaas/training/predict_models/TFT"))

# Define the monitoring sequence
monitoring_sequence = np.array([38,48,50,26,20,25,24,42,28,27,27,35,40])
...
forecast_it = predictor.predict(dataset=monitoring_data, num_samples=100)
